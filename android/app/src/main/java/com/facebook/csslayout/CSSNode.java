...
public class CSSNode {
  ...
  public interface MeasureFunction {
     ...
     */
    void measure(CSSNode node, float width, CSSMeasureMode widthMode, float height, CSSMeasureMode heightMode, MeasureOutput measureOutput);
  }
  ...
  /*package*/ MeasureOutput measure(MeasureOutput measureOutput, float width, CSSMeasureMode widthMode, float height, CSSMeasureMode heightMode) {
    ...
    mMeasureFunction.measure(this, width, widthMode, height, heightMode, measureOutput);
