...
public class TextVNode extends ViewBasedVNode implements CSSNode.MeasureFunction, SpanTextProvider {
    ...
    int validateView(int indexInParent) {
        ...
        accu.Flush();
        ((DecoratedTextView) view).setText(builder);
        return res;
    }
